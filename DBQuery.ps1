...
# Current version : 1.1
# Current Release date : 05/02/2018
# Version History : Currently, there is no other version
# Author : Ibermática (Vincent Seres)
#
# Usage: This script connects to MS SQL Database and returns a query result.
# Return Value : Return a System.Data.DataSet Object
# Execution: Must be executed with user having rights on DataBase.
########################################
